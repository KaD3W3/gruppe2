  ...
  <body>
        ...
        <div id="app2">
            ...
            <div v-if="this.filteroptionen">   
                ...
                <form>
                    <fieldset>
                    <legend>Suchergbinsse filtern</legend>
                    <!--  Splate 1 -->
                    <div class="row">
                        <div class="col-sm">
                            ...
                            <input  type="checkbox" 
                                    ...
                                    value="prefLabel"                             
                                    v-model="checkedFilter" >
                            <label for="prefLabel">Bevorzugte Beziechnung (#prefLabel)?</label> 
                            <br>
                        ...
                        <div class="col-sm">
                            <div>
                                ...
                                <div><b>Welche Spalten angezeigen?</b></div>                        
                                <input  type="checkbox" 
                                id="subject"
                                value="subject"                     
                                v-model="vSubject" >
                        ...
                        <table border="0" class="hoverable" >
                            ...
                            <tbody>
                                <tr v-for="(binding, bindingIndex) in this.querybindings">
                                    <td v-for="(entry,entryIndex) in binding" data-label="" >
                                        <!-- {{bindingIndex}} 
                                        {{entryIndex}}  -->
                                        {{entry.value}}
